                ...
                {!pwdFoundCheck ? (
                    ...
                    <div>
                        ...
                        {!pwdFound ? ( 
                            ...
                            <button onClick={() => window.location.href='/manager/register'} className="find-btn">
                                관리자 등록
                            </button>
                            </>
                        ):(
                            ...
                            <button onClick={() => window.location.href='/manager'} className="find-btn">
                                로그인
                            </button>
                            </>
                        )}

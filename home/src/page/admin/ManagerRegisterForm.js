...
function ManagerRegisterForm(){
    const {
        ...
        phoneCheckMessage,
        handlePhoneCheck,
    } = useGeneralRegisterForm('manager');

    return(
        <div className="container py-5">
            <div className="row justify-content-center" style={{background:"#fff", borderRadius:"20px", padding: "50px", margin:"80px 0"}}>
                <div className="col-md-8 col-lg-6">
                    <h2 className="mb-4 text-center">관리자 등록</h2>

...
function MovieDetail() {
  ...
  const relatedItems = [
    { id: 1, name: "팝업 손거울", imageId: 'e7b63fbcc29849fe', price: 7000, productUrl: '#' },
    { id: 2, name: "폭싹 손거울", imageId: 'd83c2665724f43a4', price: 9000, productUrl: '#' },
    { id: 3, name: "폭싹 손거울", imageId: 'b2928a3719a14173', price: 6000, productUrl: '#' },
    { id: 4, name: "팝업 포스터", imageId: '5d22918f8207486a', price: 7000, productUrl: '#' },
  ]

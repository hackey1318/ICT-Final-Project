...
function MovieDetail() {
  ...
  const relatedItems = [
    { id: 1, name: "팝업 손거울", imageId: 'b8e77c26d59f4f1c', price: 7000, productUrl: '#' },
    { id: 2, name: "폭싹 손거울", imageId: '21801962ab454307', price: 9000, productUrl: '#' },
    { id: 3, name: "폭싹 손거울", imageId: 'e6534f190e9b4f99', price: 6000, productUrl: '#' },
    { id: 4, name: "팝업 포스터", imageId: 'ad893823440444df', price: 7000, productUrl: '#' },
  ]

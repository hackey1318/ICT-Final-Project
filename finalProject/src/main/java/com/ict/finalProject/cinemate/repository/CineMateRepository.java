...
public interface CineMateRepository extends JpaRepository<CineMates, Integer> {
    ...
    @Query(value = "SELECT c.meeting_date, t.name, m.name, m.genre, m.director, m.open_date, c.no, c.max_member_count, u.nickname, c.movie_no, c.no, c.created_at, c.content, c.user_no, m.post_image " +
